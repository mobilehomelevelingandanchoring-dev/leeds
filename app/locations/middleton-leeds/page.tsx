...
export const metadata: Metadata = {
  ...
  description:
    'Mobile auto locksmith in Middleton, Leeds LS10. Car key replacement, lockouts & programming. Fastest response in South Leeds — typically 20–35 mins. Call 07309 903243.',
