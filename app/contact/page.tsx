...
export const metadata: Metadata = {
  ...
  description:
    'Contact Car Keys Leeds for emergency auto locksmith services. Available 24/7 across all Leeds areas. Call 07700 900000 for immediate assistance.',
            ...
            <div className="space-y-5">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="tel:+447700900000" className="text-red-600 font-bold text-xl hover:text-red-500 transition-colors">
                    07700 900000
                  </a>
