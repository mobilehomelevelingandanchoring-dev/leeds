...
export const metadata: Metadata = {
  ...
  description:
    'Full range of mobile auto locksmith services in Leeds. Car key replacement, lockouts, transponder programming, spare keys, van keys. 30–60 min response. Call 07700 900000.',
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="mt-12 bg-slate-50 rounded-2xl p-8 border border-slate-200 text-center">
          ...
          <a href="tel:+447700900000" className="btn-emergency">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
            </svg>
            Call 07700 900000 — Free Advice
          </a>
        </div>
      </section>
