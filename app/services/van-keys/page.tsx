...
export const metadata: Metadata = {
  ...
  description:
    'Mobile van key replacement and lockout service in Leeds. Ford Transit, Mercedes Sprinter, VW Transporter, Vauxhall Vivaro and more. Call 07700 900000.',
      ...
      <section className="bg-brand-navy py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            Call 07700 900000 — Van Emergency
          </a>
        </div>
      </section>
