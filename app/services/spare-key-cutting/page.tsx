...
export const metadata: Metadata = {
  ...
  description:
    'Get a spare car key cut and programmed in Leeds before you lose your original. Mobile service — we come to you. All makes. From £80. Call 07309 903243.',
