...
export const metadata: Metadata = {
  ...
  description:
    'Lost your car keys in Leeds? We replace car keys for all makes and models — cut and programmed on-site, same day. No dealer wait. From £80. Call 07700 900000.',
...
const process = [
  {
    step: '1',
    title: 'Call Us',
    description: "Phone us on 07700 900000. Tell us your vehicle make, model, and year, and where you are in Leeds. We'll confirm we can help and give you a fixed price straight away.",
  },
  {
    step: '2',
