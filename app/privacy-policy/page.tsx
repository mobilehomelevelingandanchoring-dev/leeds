    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-slate-600 text-sm leading-relaxed">
        <section>
          ...
          <p>Car Keys Leeds is a mobile auto locksmith business operating in Leeds, West Yorkshire, UK. Our website is <strong>carkeysleeds.co.uk</strong>. You can contact us at info@carkeysleeds.co.uk or 07700 900000.</p>
        </section>
